    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked_user', models.ManyToManyField(blank=True, null=True, related_name='liked_user', to=settings.AUTH_USER_MODEL, verbose_name='点赞用户')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='thread', to='tweet.Tweet', verbose_name='自关联')),
